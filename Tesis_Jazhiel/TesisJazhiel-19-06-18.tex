    ...
    \begin{titlepage}
        ...
        \begin{minipage}[c][0.81\textheight][t]{0.65\textwidth}
            \begin{center}
                ...
                {\Huge\scshape Modelos de Materia Oscura: Una Perspectiva Numérica}\\[.2in]
...
\begin{figure}
\centering
 \includegraphics[width=0.7\textwidth, height=0.4\textwidth]{./Figuras/Satellites}
...
\hline
\multirow{3}{3cm}{\footnotesize{Otras cantidades}} & Par\'ametro de Hubble & $h$  & 0.7\\         \cline{2-4}
...
\begin{figure}[htpb]
\centering
\includegraphics[angle=90,width=0.8\textwidth]{./Figuras/xy_00081_image}
\caption{\footnotesize{Simulación de formación de estructura para $\Lambda$CDM con 2 millones de part\'iculas.}} \label{fig 4.3}
\end{figure}

\begin{figure}
\centering
\includegraphics[width=0.9\textwidth]{./Figuras/masses_LCDM2M}
...
\begin{figure}
 \centering
\subfigure[$\Lambda$CDM]{\includegraphics[width=0.8\textwidth]{./Figuras/LCDM}}
\subfigure[SFDM]{\includegraphics[width=0.8\textwidth]{./Figuras/SFDM}}
