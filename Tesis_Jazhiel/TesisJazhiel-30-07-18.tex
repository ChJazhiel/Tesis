    ...
    \begin{titlepage}
        ...
        \begin{minipage}[c][0.81\textheight][t]{0.65\textwidth}
            \begin{center}
                ...
                \textsc{\large Licenciatura en Física y Matemáticas}\\[0.5cm]
...
\begin{figure}
  \begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{%
      ...
      \includegraphics[width=1.45\textwidth, height=0.88\textwidth]{./Figuras/TreePM}\label{fig 3.1}%
  \end{adjustbox}
\end{figure}
%\begin{figure}
%\centering
...
\begin{figure}
  \begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{%
      \footnotesize{Simulación de FDM con 2 millones de partículas. En esta caja de 50 Mpc se encuentran aproximadamente 670 halos de materia oscura.}
      }\end{minipage}},rotate=90,center}
      \includegraphics[width=1.45\textwidth, height=0.92\textwidth]{./Figuras/SFDM_new1_151_kpc}\label{fig 3.2}%
  \end{adjustbox}
\end{figure}
...
\begin{figure}
\centering
\subfigure[SF1($\mathcal{O}(\lambda)\sim$kpc)]{\includegraphics[width=0.4\textwidth]{./Figuras/SFDM_144_n2}}
\subfigure[SF2($\mathcal{O}(\lambda)\sim$pc)]{\includegraphics[width=0.4\textwidth]{./Figuras/SFDM_144_n1}}
\subfigure[N1]{\includegraphics[width=0.4\textwidth]{./Figuras/LCDM_N1_144}}
