...
\begin{figure}
  \begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{%
      ...
      \includegraphics[width=1.0\textwidth, height=0.5\textwidth]{./Figuras/TreePM}\label{fig 3.1}%
  \end{adjustbox}
\end{figure}
%\begin{figure}
%\centering
...
\begin{figure}
  \begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{%
      ...
      \includegraphics[width=1.45\textwidth, height=0.92\textwidth]{./Figuras/Millenium}\label{fig 3.2}%
  \end{adjustbox}
\end{figure}
%\begin{figure}
%\centering
%  \includegraphics[angle=90,width=\textwidth]{./Figuras/Millenium}
...
\begin{figure}[htpb]
\centering
\subfigure[Materia oscura]{\includegraphics[width=0.5\textwidth]{./Figuras/lcdm_DM_xy_00080}}
\subfigure[Gas]{\includegraphics[width=0.5\textwidth]{./Figuras/lcdm_gas_xy_00080gas}}
\subfigure[Estructura]{\includegraphics[width=0.9\textwidth]{./Figuras/lcdm_gas_xy_00080}}
...
\subfigure[Unidades y longitud de suavizado]{\includegraphics[width=1\textwidth, height=0.8\textwidth]{./Figuras/condiciones2}}
...
\begin{figure}
  \begin{adjustbox}{addcode={\begin{minipage}{\width}}{\caption{%
      ...
      \includegraphics[width=1.45\textwidth, height=0.92\textwidth]{./Figuras/N1_114}\label{fig 3.2}%
  \end{adjustbox}
\end{figure}
...
\begin{figure}
\centering
\subfigure[$\Lambda$CDM]{\includegraphics[width=0.4\textwidth]{./Figuras/LCDM_N1_113_2}}
\subfigure[SFDM]{\includegraphics[width=0.4\textwidth]{./Figuras/SFDM_113_2_kpc}}
\subfigure[$\Lambda$CDM]{\includegraphics[width=1\textwidth, height=0.5\textwidth]{./Figuras/LCDM_N1_113}}
\subfigure[SFDM]{\includegraphics[width=1\textwidth, height=0.5\textwidth]{./Figuras/SFDM_113_kpc}}
...
\begin{figure}
\centering
\subfigure[$\Lambda$CDM]{\includegraphics[width=0.6\textwidth]{./Figuras/N1_043}}
\subfigure[SFDM ($\lambda \sim 1.41 $ pc)]{\includegraphics[width=0.6\textwidth]{./Figuras/SFDM_N1_023}}
\subfigure[SFDM ($\lambda \sim 1.41$ kpc)]{\includegraphics[width=0.6\textwidth]{./Figuras/SFN2_069}}
...
\begin{figure}
\flushleft
\subfigure[Halos(log)]{\includegraphics[width=0.6\textwidth]{./Figuras/masses_LCDM_SFDM_log}}
\subfigure[Halos(lin)]{\includegraphics[width=0.6\textwidth]{./Figuras/masses_LCDM_SFDM_linear}}
\subfigure[HMF($\Lambda$CDM (z$\sim$2))]{\includegraphics[width=0.6\textwidth]{./Figuras/HMF_LCDM_N1_043}}
